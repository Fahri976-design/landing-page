...
export function LoginForm({
  ...
  return (
    <div className={cn("flex flex-col items-center justify-center min-h-screen bg-black text-white", className)} {...props}>
        ...
        <form className="space-y-6">
          <div>
            ...
            <Input
              ...
              required
              className="bg-[#333] border-[#333] text-white placeholder-gray-400 focus:border-[#1db954]"
            />
          </div>
          <div>
          ...
          <div className="space-y-4">
            <Button type="submit" className="w-full bg-[#1db954] hover:bg-[#1ed760] text-black font-bold py-3">
              Log In
            </Button>

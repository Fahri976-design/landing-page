        ...
        <main className="flex-1 p-8 overflow-auto">
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-6 gap-4">
              <div className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors cursor-pointer">
                <img src="https://via.placeholder.com/150x150/1db954/ffffff?text=Album" alt="Album cover" className="w-full aspect-square rounded-lg mb-3" />
          ...
          <section className="mb-8">
            ...
            <div className="grid grid-cols-4 gap-4">
              <div className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors cursor-pointer">
                <img src="https://via.placeholder.com/200x200/1db954/ffffff?text=Playlist" alt="Playlist cover" className="w-full aspect-square rounded-lg mb-3" />
          ...
          <section>
            ...
            <div className="grid grid-cols-5 gap-4">
              <div className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors cursor-pointer">
                <img src="https://via.placeholder.com/150x150/1db954/ffffff?text=Liked" alt="Liked songs" className="w-full aspect-square rounded-lg mb-3" />
                <h3 className="font-semibold text-sm">Liked Songs</h3>
                <p className="text-gray-400 text-xs">127 songs</p>
              </div>
              <div className="bg-gray-800 rounded-lg p-4 hover:bg-gray-700 transition-colors cursor-pointer">
                <img src="https://via.placeholder.com/150x150/1db954/ffffff?text=Playlist" alt="Playlist" className="w-full aspect-square rounded-lg mb-3" />
